...
export const metadata = {
  title: "Male Actors Roster | Delhi Casting Agency (DCA)",
  description:
...
export default function MaleActorsPage() {
  ...
  return (
    <main className="bg-white min-h-screen text-[#111111]">
      ...
      {/* Category CTA */}
      <CTASection
        eyebrow="Male Actor Casting"
        title="Looking to Cast a Male Lead or Supporting Artist?"
        description="Connect directly with Delhi Casting Agency for audition tapes, availability, and representation inquiries."
