...
export const metadata = {
  title: "Contemporary Dancers Roster | Delhi Casting Agency (DCA)",
  description:
    "Discover trained contemporary and lyrical artists blending modern techniques, fluid partnering, and expressive emotional narratives.",
};

export default function ContemporaryDancersPage() {
  const category = getDancerCategoryBySlug("contemporary-dancers")!;
  const dancers = getDancersByCategory("contemporary-dancers");
  const otherCategories = DANCER_CATEGORIES.filter((c) => c.slug !== "contemporary-dancers");
  ...
  return (
    <main className="bg-white min-h-screen text-[#111111]">
      ...
      {/* Category CTA */}
      <CTASection
        eyebrow="Contemporary Dance Casting"
        title="Looking for Lyrical or Neoclassical Dance Artists?"
        description="Delhi Casting Agency represents certified contemporary movement artists and choreographers."
