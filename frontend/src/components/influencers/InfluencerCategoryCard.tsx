...
import type { CategoryMeta } from "@/data/influencers";

interface InfluencerCategoryCardProps {
  category: CategoryMeta;
}

export function InfluencerCategoryCard({ category }: InfluencerCategoryCardProps) {
  return (
