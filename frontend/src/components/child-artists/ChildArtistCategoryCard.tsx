...
import type { CategoryMeta } from "@/data/child-artists";

interface ChildArtistCategoryCardProps {
  category: CategoryMeta;
}

export function ChildArtistCategoryCard({ category }: ChildArtistCategoryCardProps) {
  return (
