...
export const metadata = {
  title: "Child Boys Talent Roster | Delhi Casting Agency (DCA)",
  description:
    "Discover talented young male actors and child artists available for feature films, TVCs, and commercial projects.",
};

export default function ChildBoysPage() {
  const category = getChildCategoryBySlug("boys")!;
  const artists = getChildArtistsByCategory("boys");
  const otherCategories = CHILD_ARTIST_CATEGORIES.filter((c) => c.slug !== "boys");
  ...
  return (
    <main className="bg-white min-h-screen text-[#111111]">
      ...
      {/* Category CTA */}
      <CTASection
        eyebrow="Junior Boy Talent"
        title="Looking to Cast Child Boys for TVCs or Films?"
        description="Delhi Casting Agency manages auditions, parental approvals, and shoot readiness for verified child artists."
