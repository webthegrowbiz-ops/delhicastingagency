...
export const metadata = {
  title: "Fitness Models Roster | Delhi Casting Agency (DCA)",
  description:
    "Discover athletic and fitness models for activewear, sports campaigns, gym editorials, and wellness branding.",
};

export default function FitnessModelsPage() {
  const category = getModelCategoryBySlug("fitness-models")!;
  const models = getModelsByCategory("fitness-models");
  const otherCategories = MODEL_CATEGORIES.filter((c) => c.slug !== "fitness-models");
  ...
  return (
    <main className="bg-white min-h-screen text-[#111111]">
      ...
      {/* Category CTA */}
      <CTASection
        eyebrow="Sports &amp; Fitness Casting"
        title="Looking for Athletic Models for Sportswear or Gym Campaigns?"
        description="Delhi Casting Agency represents conditioned athletes and fitness models with high endurance."
