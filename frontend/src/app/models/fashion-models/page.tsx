...
export const metadata = {
  title: "Fashion & Runway Models Roster | Delhi Casting Agency (DCA)",
  description:
    "Discover high-fashion models trained for fashion week runways, designer lookbooks, and luxury editorial campaigns.",
};

export default function FashionModelsPage() {
  const category = getModelCategoryBySlug("fashion-models")!;
  const models = getModelsByCategory("fashion-models");
  const otherCategories = MODEL_CATEGORIES.filter((c) => c.slug !== "fashion-models");
  ...
  return (
    <main className="bg-white min-h-screen text-[#111111]">
      ...
      {/* Category CTA */}
      <CTASection
        eyebrow="Fashion Week Casting"
        title="Looking for Runway &amp; Couture Models?"
        description="Delhi Casting Agency represents premier runway talent for fashion weeks, designer shows, and luxury editorials."
