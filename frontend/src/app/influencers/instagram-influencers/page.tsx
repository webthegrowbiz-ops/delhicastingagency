...
export const metadata = {
  title: "Instagram Influencers Roster | Delhi Casting Agency (DCA)",
  description:
    "Connect with high-engagement Instagram creators and trendsetters for sponsored reels, digital campaigns, and brand partnerships.",
};

export default function InstagramInfluencersPage() {
  const category = getInfluencerCategoryBySlug("instagram-influencers")!;
  const influencers = getInfluencersByCategory("instagram-influencers");
  const otherCategories = INFLUENCER_CATEGORIES.filter((c) => c.slug !== "instagram-influencers");
  ...
  return (
    <main className="bg-white min-h-screen text-[#111111]">
      ...
      {/* Category CTA */}
      <CTASection
        eyebrow="Instagram Brand Collabs"
        title="Ready to Partner with Top Instagram Creators?"
        description="Delhi Casting Agency coordinates reel deliverables, contract terms, and campaign metrics."
