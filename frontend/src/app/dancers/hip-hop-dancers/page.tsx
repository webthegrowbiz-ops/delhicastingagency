...
export const metadata = {
  title: "Hip-Hop & Urban Dancers | Delhi Casting Agency (DCA)",
  description:
    "Explore dynamic street, hip-hop, breaking, and popping dancers for high-energy music videos and commercial brand events.",
};

export default function HipHopDancersPage() {
  const category = getDancerCategoryBySlug("hip-hop-dancers")!;
  const dancers = getDancersByCategory("hip-hop-dancers");
  const otherCategories = DANCER_CATEGORIES.filter((c) => c.slug !== "hip-hop-dancers");
  ...
  return (
    <main className="bg-white min-h-screen text-[#111111]">
      ...
      {/* Category CTA */}
      <CTASection
        eyebrow="Urban Dance Battles &amp; Music Videos"
        title="Looking for Explosive Hip-Hop Crews &amp; Soloists?"
        description="Delhi Casting Agency represents battle champions, commercial dancers, and popping/breaking specialists."
