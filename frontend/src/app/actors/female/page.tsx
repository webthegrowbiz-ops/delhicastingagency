...
export const metadata = {
  title: "Female Actors Roster | Delhi Casting Agency (DCA)",
  description:
...
export default function FemaleActorsPage() {
  ...
  return (
    <main className="bg-white min-h-screen text-[#111111]">
      ...
      {/* Category CTA */}
      <CTASection
        eyebrow="Female Actor Casting"
        title="Looking for a Leading Lady or Character Artist?"
        description="Delhi Casting Agency coordinates full audition tapes, script readings, and availability schedules for verified female actors."
