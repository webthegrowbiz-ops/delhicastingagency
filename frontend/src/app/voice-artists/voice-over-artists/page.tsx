...
export const metadata = {
  title: "Voice Over Artists Roster | Delhi Casting Agency (DCA)",
  description:
    "Discover versatile voice over talents for television commercials, corporate presentations, audiobooks, and documentaries.",
};

export default function VoiceOverArtistsPage() {
  const category = getVoiceCategoryBySlug("voice-over-artists")!;
  const artists = getVoiceArtistsByCategory("voice-over-artists");
  const otherCategories = VOICE_ARTIST_CATEGORIES.filter((c) => c.slug !== "voice-over-artists");
  ...
  return (
    <main className="bg-white min-h-screen text-[#111111]">
      ...
      {/* Category CTA */}
      <CTASection
        eyebrow="Commercial &amp; Corporate Narration"
        title="Looking for Warm, Authoritative Voiceover Talents?"
        description="Delhi Casting Agency represents broadcast-grade narrators with fast turnaround home studios."
